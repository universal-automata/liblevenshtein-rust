...
fn load_test_dictionary() -> PathMapDictionary<()> {
    ...
    let words = vec![
        ...
        "testing", "benchmark", "performance", "optimization", "implementation",
        "algorithm", "dictionary", "transducer", "levenshtein", "automaton",
        "intersection", "traversal", "efficient", "comparison", "measurement",
    ];
